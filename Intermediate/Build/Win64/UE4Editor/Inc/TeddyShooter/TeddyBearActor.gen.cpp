...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATeddyBearActor_OnOverlapBegin_Statics::NewProp_OverlappedComponent_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ATeddyBearActor_OnOverlapBegin_Statics::NewProp_OverlappedComponent = { "OverlappedComponent", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TeddyBearActor_eventOnOverlapBegin_Parms, OverlappedComponent), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ATeddyBearActor_OnOverlapBegin_Statics::NewProp_OverlappedComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ATeddyBearActor_OnOverlapBegin_Statics::NewProp_OverlappedComponent_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATeddyBearActor_OnOverlapBegin_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATeddyBearActor_OnOverlapBegin_Statics::NewProp_OverlappedComponent,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATeddyBearActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATeddyBearActor_OnOverlapBegin, "OnOverlapBegin" }, // 4194448206
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATeddyBearActor, 4047991334);
