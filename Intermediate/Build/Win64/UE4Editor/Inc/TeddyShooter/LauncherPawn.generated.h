...
#ifdef TEDDYSHOOTER_LauncherPawn_generated_h
#error "LauncherPawn.generated.h already included, missing '#pragma once' in LauncherPawn.h"
#endif
...
public: \
	DECLARE_CLASS(ALauncherPawn, APawn, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/TeddyShooter"), NO_API) \
...
#define TeddyShooter_Source_TeddyShooter_LauncherPawn_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ALauncherPawn); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ALauncherPawn); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ALauncherPawn(ALauncherPawn&&); \
	NO_API ALauncherPawn(const ALauncherPawn&); \
public:
...
template<> TEDDYSHOOTER_API UClass* StaticClass<class ALauncherPawn>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID TeddyShooter_Source_TeddyShooter_LauncherPawn_h
