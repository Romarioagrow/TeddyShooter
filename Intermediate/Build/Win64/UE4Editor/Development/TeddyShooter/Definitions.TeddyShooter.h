...
#define UE_PROJECT_NAME TeddyShooter
#define UE_TARGET_NAME TeddyShooterEditor
#define UE_MODULE_NAME "TeddyShooter"
...
#define TEDDYSHOOTER_API DLLEXPORT
